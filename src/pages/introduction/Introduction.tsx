    ...
    return (
        <>
            ...
            <HeadPartyWordsContent>
                ...
                <p>
                    אני גאה ונרגש שרשימה מיוחדת זו היוותה השראה לרשימות רבות בכל
                    רחבי הארץ שהציפו את סדר היום היישובי שלהן בצורך בשוויון
                    אמיתי לקהילת משפחות בעלות צרכים מיוחדים, על כל גווניה.
                </p>
                <p>
                    קיבלתי עליי את האתגר להיות שליח ציבור של אוכלוסייה מיוחדת עם
                    צרכים מיוחדים, אבל בפועל עבדתי בהתנדבות למען
                ...
                <p>
                    סיעת שווים הייתה דוגמא ומופת לרשויות רבות שהבינו את החשיבות
                    והצורך לטפל במשפחות עם צרכים מיוחדים והפיכתם לחברי קהילה ולא
                    רק "תושבים".
                </p>
                <h3>
                ...
                <ul>
                    ...
                    <li>
                        יוזמה שלי: קייטנה בת חמישה ימים לילדים המיוחדים בחופש
                        הגדול, הפועלת מזה 3 שנים.
                    </li>
                    <li>הקמת תנועת הנוער "כנפיים של קרמבו" בשוהם.</li>
                    <li>
                        כמחזיק תיק הרווחה ובשיתוף עם חבר המועצה שימי אלבאז מחזיק
                        תיק הספורט, פעלתי להפעלת חוגים לילדים עם צרכים מיוחדים:
                        מכבי שוהם – כדורגל, שחיה וטניס שולחן. במסגרת המועדונית-
                        חוג כדורסל. כמו כן, חוג מקהלה מיוחדת.
                    </li>
                    <li>
                        הקמת "בית לחיים" בהובלתו של ראש המועצה, איתן פטיגרו.
                    </li>
                    <li>שותף בהקמה ובחירה של מתקנים בגן היובל, הגן הנגיש.</li>
                    <li>
                ...
                <p>
                    ...
                    משפחות מיוחדות שבחרו לחיות בה בשל תשומת הלב המיוחדת שמוענקת
                    להם.
                </p>
                <p>
                    בזכות סיעת "שווים" שוהם מדברת קהילה סובלנית ומכילה את האחר.
                </p>
                <p>
                    <b>לכן </b>
                    נדרש עדיין קול עקבי בתוך המועצה שימשיך את העבודה החשובה
                    שאנחנו עושים, היום יותר מתמיד: שוהם מתרחבת בקצב מהיר ומטבע
                    הדברים הצרכים המיוחדים של הקהילות השונות, גדלים אף הם.
                </p>
                <p>
